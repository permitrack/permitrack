...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sp_heat_asset_ratings_under_meter]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_heat_asset_ratings_under_meter]
GO

CREATE PROCEDURE dbo.sp_heat_asset_ratings_under_meter
	-- Required Parameters
	@meterId  int = NULL
AS
