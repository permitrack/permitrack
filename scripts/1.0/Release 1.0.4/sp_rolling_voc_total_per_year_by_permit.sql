...
WHILE (SELECT COUNT(*) FROM #TEMP_PERMITTED_ASSETS) > 0
  BEGIN
	...
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@JanPrevStartDate, @endDate=@JanPrevEndDate, @assetId=@aId
	SET @JanuaryPrev = @JanuaryPrev + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@FebPrevStartDate, @endDate=@FebPrevEndDate, @assetId=@aId
	SET @FebruaryPrev = @FebruaryPrev + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@MarPrevStartDate, @endDate=@MarPrevEndDate, @assetId=@aId
	SET @MarchPrev = @MarchPrev + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@AprPrevStartDate, @endDate=@AprPrevEndDate, @assetId=@aId
	SET @AprilPrev = @AprilPrev + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@MayPrevStartDate, @endDate=@MayPrevEndDate, @assetId=@aId
	SET @MayPrev = @MayPrev + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@JunPrevStartDate, @endDate=@JunPrevEndDate, @assetId=@aId
	SET @JunePrev = @JunePrev + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@JulPrevStartDate, @endDate=@JulPrevEndDate, @assetId=@aId
	SET @JulyPrev = @JulyPrev + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@AugPrevStartDate, @endDate=@AugPrevEndDate, @assetId=@aId
	SET @AugustPrev = @AugustPrev + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@SepPrevStartDate, @endDate=@SepPrevEndDate, @assetId=@aId
	SET @SeptemberPrev = @SeptemberPrev + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@OctPrevStartDate, @endDate=@OctPrevEndDate, @assetId=@aId
	SET @OctoberPrev = @OctoberPrev + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@NovPrevStartDate, @endDate=@NovPrevEndDate, @assetId=@aId
	SET @NovemberPrev = @NovemberPrev + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@DecPrevStartDate, @endDate=@DecPrevEndDate, @assetId=@aId
	SET @DecemberPrev = @DecemberPrev + @hold
	SET @hold = 0
	
	
	-- get this year's month to month totals
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@JanStartDate, @endDate=@JanEndDate, @assetId=@aId
	SET @January = @January + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@FebStartDate, @endDate=@FebEndDate, @assetId=@aId
	SET @February = @February + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@MarStartDate, @endDate=@MarEndDate, @assetId=@aId
	SET @March = @March + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@AprStartDate, @endDate=@AprEndDate, @assetId=@aId
	SET @April = @April + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@MayStartDate, @endDate=@MayEndDate, @assetId=@aId
	SET @May = @May + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@JunStartDate, @endDate=@JunEndDate, @assetId=@aId
	SET @June = @June + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@JulStartDate, @endDate=@JulEndDate, @assetId=@aId
	SET @July = @July + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@AugStartDate, @endDate=@AugEndDate, @assetId=@aId
	SET @August = @August + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@SepStartDate, @endDate=@SepEndDate, @assetId=@aId
	SET @September = @September + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@OctStartDate, @endDate=@OctEndDate, @assetId=@aId
	SET @October = @October + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@NovStartDate, @endDate=@NovEndDate, @assetId=@aId
	SET @November = @November + @hold
	SET @hold = 0
	
	EXEC @hold = dbo.sp_total_voc_month_by_asset @startDate=@DecStartDate, @endDate=@DecEndDate, @assetId=@aId
