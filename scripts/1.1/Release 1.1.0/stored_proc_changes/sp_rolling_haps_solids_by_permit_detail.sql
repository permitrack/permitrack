...
CREATE TABLE #TEMP_HOLD_ASSET_HAPS (
	A_ID int,
	SUM_LBS_HAPS float(8)
)

CREATE TABLE #TEMP_HOLD_ASSET_SOLIDS (
	A_ID int,
...
WHILE (SELECT COUNT(*) FROM #TEMP_PERMITTED_ASSETS) > 0
  BEGIN
    SELECT TOP 1 @aId = A_ID FROM #TEMP_PERMITTED_ASSETS
	 ...
	 --------------------------------------------
	 -- JANUARY PREVIOUS
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@JanPrevStartDate, @endDate=@JanPrevEndDate, @assetId=@aId	
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@JanPrevStartDate, @endDate=@JanPrevEndDate, @assetId=@aId		
		
	IF ((SELECT COUNT(*) FROM #TEMP_HOLD_ASSET_HAPS) > 0 )	
	BEGIN
		SELECT TOP 1 @hapsHold = SUM_LBS_HAPS FROM #TEMP_HOLD_ASSET_HAPS		
		SET @JanuaryPrevHaps = @JanuaryPrevHaps + @hapsHold
		DELETE FROM #TEMP_HOLD_ASSET_HAPS
		SET @hapsHold = 0
	END
	
	IF ((SELECT COUNT(*) FROM #TEMP_HOLD_ASSET_SOLIDS) > 0 )	
	BEGIN	
		SELECT TOP 1 @solidsHold = SUM_SOLIDS_VOLUME FROM #TEMP_HOLD_ASSET_SOLIDS	
		SET @JanuaryPrevSolids = @JanuaryPrevSolids + @solidsHold
		DELETE FROM #TEMP_HOLD_ASSET_SOLIDS
		SET @solidsHold = 0
	END
	 ...
	 -- FEBRUARY PREVIOUS
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@FebPrevStartDate, @endDate=@FebPrevEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@FebPrevStartDate, @endDate=@FebPrevEndDate, @assetId=@aId
	...
	END
	 ...
	 -- MARCH PREVIOUS
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@MarPrevStartDate, @endDate=@MarPrevEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@MarPrevStartDate, @endDate=@MarPrevEndDate, @assetId=@aId
	...
	END
	 ...
	 -- APRIL PREVIOUS
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@AprPrevStartDate, @endDate=@AprPrevEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@AprPrevStartDate, @endDate=@AprPrevEndDate, @assetId=@aId
	...
	END
	 ...
	 -- MAY PREVIOUS
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@MayPrevStartDate, @endDate=@MayPrevEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@MayPrevStartDate, @endDate=@MayPrevEndDate, @assetId=@aId
	...
	END
	 ...
	 -- JUNE PREVIOUS
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@JunPrevStartDate, @endDate=@JunPrevEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@JunPrevStartDate, @endDate=@JunPrevEndDate, @assetId=@aId
	...
	END
	 ...
	 -- JULY PREVIOUS
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@JulPrevStartDate, @endDate=@JulPrevEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@JulPrevStartDate, @endDate=@JulPrevEndDate, @assetId=@aId
	...
	END
	 ...
	 -- AUGUST PREVIOUS
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@AugPrevStartDate, @endDate=@AugPrevEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@AugPrevStartDate, @endDate=@AugPrevEndDate, @assetId=@aId
	...
	END
	 ...
	 -- SEPTEMBER PREVIOUS	
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@SepPrevStartDate, @endDate=@SepPrevEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@SepPrevStartDate, @endDate=@SepPrevEndDate, @assetId=@aId
	...
	END
	 ...
	 -- OCTOBER PREVIOUS
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@OctPrevStartDate, @endDate=@OctPrevEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@OctPrevStartDate, @endDate=@OctPrevEndDate, @assetId=@aId
	...
	END
	 ...
	 -- NOVEMBER PREVIOUS
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@NovPrevStartDate, @endDate=@NovPrevEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@NovPrevStartDate, @endDate=@NovPrevEndDate, @assetId=@aId
	...
	END
	 ...
	 -- DECEMBER PREVIOUS
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@DecPrevStartDate, @endDate=@DecPrevEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@DecPrevStartDate, @endDate=@DecPrevEndDate, @assetId=@aId
	...
	END	
	 ...
	 -- JANUARY 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@JanStartDate, @endDate=@JanEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@JanStartDate, @endDate=@JanEndDate, @assetId=@aId
	...
	END	
	 ...
	 -- FEBRUARY 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@FebStartDate, @endDate=@FebEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@FebStartDate, @endDate=@FebEndDate, @assetId=@aId
	...
	END
	 ...
	 -- MARCH 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@MarStartDate, @endDate=@MarEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@MarStartDate, @endDate=@MarEndDate, @assetId=@aId
	...
	END
	 ...
	 -- APRIL 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@AprStartDate, @endDate=@AprEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@AprStartDate, @endDate=@AprEndDate, @assetId=@aId
	...
	END
	 ...
	 -- MAY 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@MayStartDate, @endDate=@MayEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@MayStartDate, @endDate=@MayEndDate, @assetId=@aId
	...
	END
	 ...
	 -- JUNE 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@JunStartDate, @endDate=@JunEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@JunStartDate, @endDate=@JunEndDate, @assetId=@aId
	...
	END	
	 ...
	 -- JULY 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@JulStartDate, @endDate=@JulEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@JulStartDate, @endDate=@JulEndDate, @assetId=@aId
	...
	END	
	 ...
	 -- AUGUST 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@AugStartDate, @endDate=@AugEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@AugStartDate, @endDate=@AugEndDate, @assetId=@aId
	...
	END	
	 ...
	 -- SEPTEMBER 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@SepStartDate, @endDate=@SepEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@SepStartDate, @endDate=@SepEndDate, @assetId=@aId
	...
	END	
	 ...
	 -- OCTOBER 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@OctStartDate, @endDate=@OctEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@OctStartDate, @endDate=@OctEndDate, @assetId=@aId
	...
	END	
	 ...
	 -- NOVEMBER 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@NovStartDate, @endDate=@NovEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@NovStartDate, @endDate=@NovEndDate, @assetId=@aId
	...
	END	
	 ...
	 -- DECEMBER 
	INSERT INTO #TEMP_HOLD_ASSET_HAPS
		EXEC dbo.sp_total_haps_by_asset @startDate=@DecStartDate, @endDate=@DecEndDate, @assetId=@aId
	INSERT INTO #TEMP_HOLD_ASSET_SOLIDS
		EXEC dbo.sp_total_solids_by_asset @startDate=@DecStartDate, @endDate=@DecEndDate, @assetId=@aId
...
DROP TABLE #TEMP_HOLD_ASSET_HAPS	
DROP TABLE #TEMP_HOLD_ASSET_SOLIDS
