...
public class ProjectTypeEditAction
    extends ProjectBaseAction
{
    ...
    { // project Action
        ...
        String
            strLog =
            new String("ProjectTypeEditAction.projectAction: ");
        String
            strError;
        ProjectTypeValue
            projectTypeValue =
        ...
        { // User did not cancel
            ...
            { // Project type form is not null
                ...
                originalProjectTypeValue =
                    ProjectTypeService.getProjectTypeById(projectTypeForm.getId());
                if (!originalProjectTypeValue.getName()
                    .equals(projectTypeForm.getName()))
                { // Check for duplicate
                    projectTypeValue =
                ...
                { // project type value is not a duplicate
                    ...
                    { // Save the new project type
                        ...
                        ProjectTypeService.setProjectTypeInSessionAndRequest(intProjectTypeId,
                                                                             request);
                        addMessage(new ActionMessage("project.type.update.success"),
                                   request);
                    } // Save the new project type
                    catch (Exception e)
                ...
                { // Project type value is a duplicate, redirect to create new page
                    ...
                    projectTypeValue.setId(projectTypeForm.getId());
