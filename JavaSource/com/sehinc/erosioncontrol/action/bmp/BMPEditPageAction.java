...
public class BMPEditPageAction
    extends BMPBaseAction
{
    private static
    Logger
        LOG =
        Logger.getLogger(BMPEditPageAction.class);
        ...
        throws Exception
    {
        ...
        if (!securityManager.HasECPermission(com.sehinc.security.SecureObjectPermissionData.BMP_UPDATE))
        {
            Object[]
                parameters =
                {
