...
public abstract class PermitDetailBaseAction
    extends ClientBaseAction
{
    private static
    Logger
        LOG =
        Logger.getLogger(PermitDetailBaseAction.class);

    public abstract ActionForward permitDetailAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws Exception;
    ...
    public ActionForward clientAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws Exception
    {
        return permitDetailAction(mapping,
                                  form,
                                  request,
                                  response);
    }
