...
public abstract class FacilityBaseAction
    extends ClientBaseAction
{
    public abstract ActionForward facilityAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws Exception;
        ...
        throws ServletException
    {
        ...
        {
            secondaryMenu =
                SecondaryMenu.getInstance(SecondaryMenu.FACILITY_LIST_MENU);
            secondaryMenu.setCurrentItem(SecondaryMenu.FACILITY_LIST_MENU_ITEM);
        }
