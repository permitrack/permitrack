...
public abstract class PermitSubstanceBaseAction
    extends ClientBaseAction
{
    public abstract ActionForward permitSubstanceAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws Exception;
    ...
    public ActionForward clientAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws Exception
    {
        return permitSubstanceAction(mapping,
                                     form,
                                     request,
                                     response);
    }
