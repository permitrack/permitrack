...
public abstract class SubstanceSccBaseAction
    extends ClientBaseAction
{
    public abstract ActionForward substanceSccAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws Exception;
    ...
    public ActionForward clientAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws Exception
    {
        return substanceSccAction(mapping,
                                  form,
                                  request,
                                  response);
    }
