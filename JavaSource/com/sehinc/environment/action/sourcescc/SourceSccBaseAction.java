...
public abstract class SourceSccBaseAction
    extends ClientBaseAction
{
    public abstract ActionForward sourceSccAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws Exception;
    ...
    public ActionForward clientAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws Exception
    {
        return sourceSccAction(mapping,
                               form,
                               request,
                               response);
    }
