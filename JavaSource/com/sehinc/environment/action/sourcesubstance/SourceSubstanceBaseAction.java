...
public abstract class SourceSubstanceBaseAction
    extends ClientBaseAction
{
    public abstract ActionForward sourceSubstanceAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws Exception;
    ...
    public ActionForward clientAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        throws Exception
    {
        return sourceSubstanceAction(mapping,
                                     form,
                                     request,
                                     response);
    }
