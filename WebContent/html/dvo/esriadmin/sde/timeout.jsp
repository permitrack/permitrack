...
<html>
<head>
	<title>Session Timed Out - Administrator</title>
</head>
		...
		<td align="left">
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<TD WIDTH="175" HEIGHT="35" ALIGN="center" VALIGN="middle" BACKGROUND="../images/Tab_selected.gif"><font face="Arial,Helvetica,sans-serif" size="-2" color="#000099"><b>Session<br>Timeout</b></font></TD>
							...
							<TR>
								<TD ALIGN="center" VALIGN="middle">
									<font face="Arial,Helvetica,sans-serif" color="#000099" size="-1"><b>
										Current Administration Session has stopped.<p> This may be due to an extended period of user inactivity,<br>
										or the server may have been restarted.<p>
										Please log in again to continue.<p>
										<form>
											<input type="button" name="goLogin" value="Log In" onclick="document.location='../default.htm'">
										</form>
