...
var theShapeXMLString = "";  // string that will hold the XML code for current selection shape
var tempShowSelectedAttributesImmediately = showSelectedAttributesImmediately;
/*
 ***************************************************************************************
...
function writeShapeXML(theType)
{
    var theString = "";
    if (theType
        == 1)
...
// write out xml request for selection by shape for all specified layers (assumes shape XML has already been written)
...
{
    tempShowSelectedAttributesImmediately =
    showSelectedAttributesImmediately;
    showSelectedAttributesImmediately =
    false;
    queryStartRecord =
    1;
        ...
        || (canSelectInvisible))
    {
            ...
            && (showSelectedFeatures))
        {
            ...
            else
            {
                ...
                selString +=
                '<SIMPLEPOLYGONSYMBOL boundarytransparency="0.5" filltransparency="0.3" fillcolor="210,255,200" boundarywidth="3" boundarycaptype="round" boundarycolor="0,0,225" />\n';
            }
            selString +=
            '</SIMPLERENDERER>\n';
            selString +=
