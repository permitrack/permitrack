...
<html:form styleClass="form-horizontal"
           action="/permitdetailcreateaction"
    ...
    <div>
        ...
        <div class="control-group">
            <label class="control-label"><bean:message key="permit.detail.avg.period" />
            </label>
            <div class="controls"><html:text property="avgPeriod"
                                             styleId="avgPeriod"
                                             name="PermitDetailForm" />
                <html:select name="PermitDetailForm"
                             property="avgPeriodUm"
                             styleId="avgPeriodUm">
        ...
        <div class="control-group">
            <label class="control-label"><bean:message key="permit.detail.voc.limit" />
            </label>
            <div class="controls"><html:text property="vocLimit"
                                             styleId="vocLimit"
                                             name="PermitDetailForm" />
                <html:select name="PermitDetailForm"
                             property="vocLimitUm"
        ...
        <div class="control-group">
            <label class="control-label"><bean:message key="permit.detail.haps.limit" />
            </label>
            <div class="controls"><html:text property="hapsLimit"
                                             styleId="hapsLimit"
                                             name="PermitDetailForm" />
                <html:select name="PermitDetailForm"
                             property="hapsLimitUm"
                             styleId="hapsLimitUm">
                    <html:option value="0">Select a Unit...</html:option>
        ...
        <div class="control-group">
            <label class="control-label"><bean:message key="permit.detail.mmbtu.limit" />
            </label>
            <div class="controls"><html:text property="mmbtuLimit"
                                             styleId="mmbtuLimit"
                                             name="PermitDetailForm" />
                <html:select name="PermitDetailForm"
