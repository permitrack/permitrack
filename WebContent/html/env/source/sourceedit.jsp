...
<html:form styleClass="form-horizontal"
    ...
    <div>
        <div class="control-group">
            ...
            <div class="controls">
                <html:select styleId="typeSelect"
                                               name="SourceForm"
        ...
        <div class="control-group">
            <label class="control-label"><bean:message key="source.displayName" />
            </label>
            <div class="controls"><bean:write name="SourceForm"
                                              property="displayName" />
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">
                <bean:message key="source.desc" /> *
            </label>
        ...
        <div class="control-group">
            ...
            <div class="controls"><html:text property="batchNumber"
                                             name="SourceForm"
                                             maxlength="50" />
            </div>
        </div>
        ...
        <div class="control-group">
            <label class="control-label"><bean:message key="source.info.color" />
            </label>
            <div class="controls"><html:select styleId="colorSelect"
                                               name="SourceForm"
                                               property="displayColorCd">
                <html:option value="">Select a Color...</html:option>
                <html:option value="#000000"
                             style="background-color: Black; color: #FFFFFF;">Black</html:option>
                <html:option value="#808080"
                             style="background-color: Gray;">Gray</html:option>
                <html:option value="#A9A9A9"
                             style="background-color: DarkGray;">Dark Gray</html:option>
                <html:option value="#D3D3D3"
                             style="background-color: #D3D3D3;">Light Gray</html:option>
                <html:option value="#FFFFFF"
                             style="background-color: White;">White</html:option>
                <html:option value="#7FFFD4"
                             style="background-color: Aquamarine;">Aquamarine</html:option>
                <html:option value="#0000FF"
                             style="background-color: Blue;">Blue</html:option>
                <html:option value="#000080"
                             style="background-color: Navy;color: #FFFFFF;">Navy</html:option>
                <html:option value="#800080"
                             style="background-color: Purple;color: #FFFFFF;">Purple</html:option>
                <html:option value="#FF1493"
                             style="background-color: DeepPink;">Deep Pink</html:option>
                <html:option value="#EE82EE"
                             style="background-color: Violet;">Violet</html:option>
                <html:option value="#FFC0CB"
                             style="background-color: Pink;">Pink</html:option>
                <html:option value="#006400"
                             style="background-color: DarkGreen;color: #FFFFFF;">Dark Green</html:option>
                <html:option value="#008000"
                             style="background-color: Green;color: #FFFFFF;">Green</html:option>
                <html:option value="#9ACD32"
                             style="background-color: YellowGreen;">Yellow Green</html:option>
                <html:option value="#FFFF00"
                             style="background-color: Yellow;">Yellow</html:option>
                <html:option value="#FFA500"
                             style="background-color: Orange;">Orange</html:option>
                <html:option value="#FF0000"
                             style="background-color: Red;">Red</html:option>
                <html:option value="#A52A2A"
                             style="background-color: Brown;">Brown</html:option>
                <html:option value="#DEB887"
                             style="background-color: BurlyWood;">Burly Wood</html:option>
                <html:option value="#F5F5DC"
                             style="background-color: Beige;">Beige</html:option>
            </html:select>
            </div>
        </div>
        <div class="control-group">
    ...
    <div>
        <div class="control-group">
            ...
            <div class="controls"><html:text styleId="lbsVoc"
                                             property="lbsVoc"
                                             name="SourceForm"
                                             size="20" />
