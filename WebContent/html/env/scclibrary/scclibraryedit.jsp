...
<html:form styleClass="form-horizontal"
    ...
    <div>
        ...
        <div class="control-group">
            <label class="control-label">
                <bean:message key="scc.library.desc" />
            </label>
            <div class="controls">
        ...
        <div class="control-group">
            <label class="control-label">
                <bean:message key="scc.library.majGrp" />
            </label>
            <div class="controls">
                <html:text property="majIndustrialGroup"
                           size="50"
                           maxlength="50" />
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">
                <bean:message key="scc.library.rawMat" />
            </label>
            <div class="controls">
                <html:text property="rawMaterial"
                           size="50"
                           maxlength="50" />
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">
                <bean:message key="scc.library.emitProc" />
            </label>
            <div class="controls">
                <html:text property="emittingProcess"
                           size="50"
                           maxlength="50" />
            </div>
        </div>
