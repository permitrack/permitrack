...
<html:form styleClass="form-horizontal"
    ...
    <div>
        <div class="control-group">
            ...
            <div class="controls"><html:text name="RoleEVForm"
                                             property="name"
                                             styleId="name"
                                             size="50" />
        ...
        <tiles:put name="scripts"
            ...
            <script type="text/javascript">
                ...
                function RequiredFields()
                {
                    ...
                    {
                        strMessage
                                = strMessage.concat("Environment (ENV) Role Name is required, ");
                    }
                    if (txtDE.value
                            == "")
                    {
                        strMessage
                                = strMessage.concat("Environment (ENV) Role Description is required, ");
                    }
                    if (RoleExists(txtNM.value))
                    {
                        strMessage
                                = strMessage.concat("Environment (ENV) Role Name already exists.  Enter a different name and try again., ");
                    }
                    if (InValidChars(txtNM.value))
                    {
                        strMessage
                                = strMessage.concat("Environment (ENV) Role Name contains invalid characters, ");
                    }
