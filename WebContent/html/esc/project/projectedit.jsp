...
<html:form styleClass="form-horizontal"
    ...
    <div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select id="projectStatusCode"
                        ...
                        onchange="return checkForCompletion();">
                    <option value="">Select...</option>
        ...
        <div class="control-group">
            <label class="control-label"
                   for="completedDate">
                <bean:message key="project.completed.date" />
            </label>
            <div class="controls">
                <input type="text"
                       id="completedDate"
            ...
            <div class="controls">
                <div>
                    <label class="checkbox">
                        <input type="checkbox"
                               id="inspectionOverdueNotificationEnabled"
                               name="inspectionOverdueNotificationEnabled"
                               alt="Enable Inspection Overdue Notifications"
                               title="Enable Inspection Overdue Notifications" />
                        Enable Inspection Overdue Notifications
                    </label>
                    <label for="inspectionOverdueInitialThreshold">
                        Send <strong>Initial</strong> Inspection Overdue Notification at
                    </label>
                    <input type="text"
                           id="inspectionOverdueInitialThreshold"
                           name="inspectionOverdueInitialThreshold"
                           size="5"
                           alt="Initial Inspection Overdue Threshold"
                           title="Initial Inspection Overdue Threshold"
                           class="span1" />
                    ...
                    <br/>
                    <p>
                        <label for="inspectionOverdueInitialMessage">
                            Inital Inspection Overdue Message
                        </label>
                        <textarea
                               id="inspectionOverdueInitialMessage"
                               name="inspectionOverdueInitialMessage"
                               rows="4"
                               cols="60"
                               title="Inital Inspection Overdue Message" ></textarea>
                    </p>
                </div>
                <br/>
                <div>
                    <label class="checkbox">
                        <input type="checkbox"
                               id="secondInspectionOverdueNotificationEnabled"
                               name="secondInspectionOverdueNotificationEnabled"
                               alt="Enable Secondary Inspection Overdue Notifications"
                               title="Enable Secondary Inspection Overdue Notifications" />
                        Enable Secondary Inspection Overdue Notifications
                    </label>
                    <label for="inspectionOverdueSecondThreshold">
                        Send <strong>Secondary</strong> Inspection Overdue Notification at
                    </label>
                    <input type="text"
                           id="inspectionOverdueSecondThreshold"
                           name="inspectionOverdueSecondThreshold"
                           size="5"
                           alt="Secondary Inspection Overdue Threshold"
                           title="Secondary Inspection Overdue Threshold"
                           class="span1" />
                    <span class="help-inline">
                        days since last inspection.
                    </span>
                    <br/>
                    <p>
                        <label for="inspectionOverdueSecondMessage">
                            Secondary Inspection Overdue Message
                        </label>
                        <textarea
                               id="inspectionOverdueSecondMessage"
                               name="inspectionOverdueSecondMessage"
                               rows="4"
                               cols="60"
                               title="Inital Inspection Overdue Message" ></textarea>
                    </p>
    ...
    <tiles:definition id="scripts"
        ...
        <tiles:put name="scripts"
            ...
            <script type="text/javascript"
                    src='<html:rewrite module="/" page="/javascript/app/projectedit.js" />'></script>
            <script type="text/javascript">
                //<!-- Begin//Initialize the project form fields
                   ...
                   != null)
               {
                ...
                <% } %>
                    ...
                    document.getElementById('completedDate').value
                            = '<%= projectForm.getCompletedDate() %>';
                    document.getElementById('zoneId').value
                            = '<%= projectForm.getZoneId() %>';
                    document.getElementById('statusCode').value
                            = '<%= projectForm.getStatusCode() %>';
                    document.getElementById('projectStatusCode').value
                            = '<%= projectForm.getProjectStatusCode() %>';
                    ...
                    document.getElementById('inspectionFrequency').value
                            = '<%= StringUtil.escapeSingleQuote(projectForm.getInspectionFrequency()) %>';
                    document.getElementById('inspectionOverdueNotificationEnabled').checked
                            = <%= projectForm.isInspectionOverdueNotificationEnabled() %>;
                    document.getElementById('inspectionOverdueInitialThreshold').value
                            = <%= projectForm.getInspectionOverdueInitialThreshold() %>;
                    document.getElementById('inspectionOverdueInitialMessage').value
                            = '<%= StringUtil.escapeSingleQuote(projectForm.getInspectionOverdueInitialMessage()) %>';
                    document.getElementById('secondInspectionOverdueNotificationEnabled').checked
                            = <%= projectForm.isSecondInspectionOverdueNotificationEnabled() %>;
                    document.getElementById('inspectionOverdueSecondThreshold').value
                            = <%= projectForm.getInspectionOverdueSecondThreshold() %>;
                    document.getElementById('inspectionOverdueSecondMessage').value
                            = '<%= StringUtil.escapeSingleQuote(projectForm.getInspectionOverdueSecondMessage()) %>';
        ...
        int inspectionTemplateIndex = 0;
         ...
         while (bmpListIterator.hasNext()) {
           EcBmp ecBmp = (EcBmp) bmpListIterator.next(); %>
                ...
                initProjectBmpArray();//Init Project Fields
                initProjectFields();//Init Document Fields
                addDocumentInput();
                displayDocumentList();//Init Contact Arrays
                displayContactList();//Init BMP Arrays
                displayBmpList();// End -->
            </script>
            <script type="text/javascript">
                //<!--
                ...
                $(function ()
                  {
                      ...
                      $("#completedDate").datepicker({autoclose:true});
