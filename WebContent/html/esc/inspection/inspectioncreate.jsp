...
<%@ page import="com.sehinc.common.db.contact.CapContact,
                 ...
                 com.sehinc.common.util.DateUtil,
...
<html:form styleClass="form-horizontal"
    ...
    <div>
            ...
            <div class="controls">
                ...
                <span class="form-inline">
                    <a class='btn btn-info'
                       href="javascript:copyFromLastInspection();">
                        Copy from last
                    </a>
                    <label class="checkbox">
                        <input type="checkbox"
                               id="alwaysCopyFromLast"
                               onclick="saveAlways();" />
                        Always
                    </label>
                </span>
        ...
        <div class="control-group">
            <label class="control-label"
                   for="temperature"><bean:message key="inspection.temperature" />
            </label>
            <div class="controls">
                <input class="span1"
                       type="text"
    ...
    <logic:notEmpty name="<%= SessionKeys.EC_INSPECTION_BMP_DEFECT_LIST %>"
                    scope="session">
        <h4 class="myAccordian">
            <bean:message key="inspection.deficiency.heading" />
        </h4>
        <div>
            <logic:iterate id="inspectionBmp"
                           name="<%= SessionKeys.EC_INSPECTION_BMP_DEFECT_LIST %>"
                           scope="session">
                        ...
                        <dd>
                            <p>
                                <a href="<bean:write name='inspectionBmp' property='bmpDocument.downloadURL' />">
                                    <img src="<bean:write name='inspectionBmp' property='bmpDocument.downloadURL' />"
        ...
        <tiles:put name="scripts"
            ...
            <script type="text/javascript">
                ...
                function initInspectionFields()
                {
                    try
                    {
                        if ($.cookie('alwaysCopy')
                                == "true")
                        {
                            document.getElementById('alwaysCopyFromLast').checked
                                    = true;
                            copyFromLastInspection();
                        }
                    }
                    catch (e)
                    {
                ...
                function copyFromLastInspection()
                {
                    try
                    {
                        document.getElementById('weatherTrends').value
                ...
                {
                <% Iterator bmpListIterator = ((List) request.getSession().getAttribute(SessionKeys.EC_PROJECT_BMP_LIST)).iterator();
       while (bmpListIterator.hasNext()) {
       ProjectBmpValue bmpValue = (ProjectBmpValue) bmpListIterator.next();
       java.lang.String conditionId = "";
       java.lang.String statusId = EcInspectionBmpStatus.BMP_STATUS_ACTIVE.toString();
              ...
              EcInspectionBmpCondition.BMP_CONDITION_NOT_APPLICABLE
                  .toString();
                    ...
                    inspectionBmpArray.push(new InspectionBmp('',
                                                              ...
                                                              '<%= StringUtil.escapeSingleQuote(bmpValue.getBmpName()) %>',
                                                              '<%= StringUtil.escapeSingleQuote(bmpValue.getBmpCategoryName()) %>',
                                                              '<%= StringUtil.escapeSingleQuote(bmpValue.getBmpDescription()) %>',
                                                              '',
                                                              '',
                                                              '<%= statusId %>',
                                                              '<%= conditionId %>',
           ...
           InspectionBmpConditionValue conditionValue = (InspectionBmpConditionValue) bmpConditionIterator.next(); %>
                ...
                function createBmpInput(bmp, index)
                {
                    ...
                    var inputStringIsInspected = "<div class='control-label'>Inspected</div><div class='controls'><div class='form-inline'>"
                                                         + "<input  class=\"ui-button\" type=\"radio\" id=\"radioInspectedYes"
                                                         + id
                                                         + "\" name=\"bmps.bmp"
                                                         + id
                            ...
                            : "")
                                                         ...
                                                         + id
                                                         + "\">Yes</label>"
                                                         + "<input  class=\"ui-button\" type=\"radio\" id=\"radioInspectedNo"
                                                         + id
                                                         + "\" name=\"bmps.bmp"
                                                         + id
                ...
                var formFileAdd = 0;
                function InspectionDocument(id)
                {
                    this.id
                            = id;
                }
                ...
                initInspectionFields();//Init BMP Arrays
