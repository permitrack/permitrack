        ...
        <table class="table table-hover action-first action-small">
            ...
            <tbody>
                <logic:iterate id="contact"
                    ...
                    <tr>
                        <td>
                            <html:multibox name="inspectionEmailForm"
    ...
    <tiles:put name="scripts"
        ...
        <script type="text/javascript">
            function SetAllCheckBoxes()
            {
                ...
                for (var i = 0; i
                        < document.inspectionEmailForm.elements.length; i++)
                {
                    if (document.inspectionEmailForm.elements[i].name
                            == 'projectContacts')
                    {
                        document.inspectionEmailForm.elements[i].checked
                                = CheckValue;
                        //                $.uniform.update(document.inspectionEmailForm.elements[i]);
                    }
                }
            }
        </script>
