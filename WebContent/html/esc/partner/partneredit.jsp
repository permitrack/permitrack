...
<html:form styleClass="form-horizontal"
           action="/partnereditaction"
           onsubmit="return validateForm(this);">
    <html:hidden styleId="id"
                 name="partnerForm"
                 property="id" />
    <html:hidden styleId="contactUserId"
                 name="partnerForm"
                 property="contactUserId" />
    <fieldset><legend>
        <bean:write name="partnerForm"
                    property="name" />
    </legend></fieldset>
    ...
    <div>
        <div class="control-group">
            ...
            <div class="controls"><bean:write name="partnerForm"
                                              property="name" />
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls"><bean:write name="partnerForm"
                ...
                <logic:notEmpty name="partnerForm"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <logic:notPresent name="<%= SessionKeys.EC_PARTNER_USER_LIST %>"
                                  scope="session">
                    <div class="error">
                        You cannot edit this Partner because they do not have any active user accounts.
                    </div>
                    <div>
                        ...
                        <div class="spacingBottom">
                            ...
                            <div>
                                <div>
                                    Click
                                    <strong>Save</strong>
                                    to re-send the account information for this Primary Contact via email.
                                </div>
                                <div>
                                    If you change the Primary Contact Email Address the account information will be sent to this new address.
                                </div>
                            </div>
                        </div>
                    </logic:notEmpty>
        ...
        <tiles:put name="scripts"
            ...
            <script type="text/javascript">
                ...
                function validateForm(form)
                {
                    ...
                    var selectedIndex = -1;
                    var selectedIndexElement = document.partnerForm.selectedIndex;
                    ...
                    var contactEmailListElement = document.partnerForm.contactEmailList;
